    ...
    function I(G, A) {
        ...
        function C() {
            ...
            try {
                 ...
                 * 尹彬
                 */
                //input距离页面左边值，距离页面上部的值
                var oldF = jQuery($dp.el).offset().left, oldB = jQuery($dp.el).offset().top;
                //页面的高度
                var innerHieght = jQuery(window).innerHeight();
                //页面的宽度
                var innerWidth = jQuery(window).innerWidth();
                if (oldB + 224 > innerHieght) {
                    B = innerHieght - 224;
                }
                if (oldF + 186 > innerWidth) {
                    F = innerWidth - 186;
                }
            } catch (e) {
            }
