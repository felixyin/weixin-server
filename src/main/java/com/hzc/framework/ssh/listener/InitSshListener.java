package com.hzc.framework.ssh.listener;
...
//        PropertiesUtil.initExtiact("/usr/local/yuwei/appServer.cfg");
        PropertiesUtil.init("/conf.properties");
